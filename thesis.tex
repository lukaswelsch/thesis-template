...
\newcommand{\titel}{Analyse und Visualisierung von Daten Qualität innerhalb eines Data Warehouse.}
...
\input{content/0_Abstrakt}\cleardoublepage

\tableofcontents

\mainmatter
\input{content/1_Einleitung}
\input{content/2_Grundlagen}
\input{content/3_Daten}
\input{content/4_Methoden}
\input{content/5_Experimente}
\input{content/6_Ausblick}
\input{content/7_Fazit}
